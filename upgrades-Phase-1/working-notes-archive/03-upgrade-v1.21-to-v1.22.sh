...
# update the `cluster-config.yaml` "ng-managed-ondemand-v1-21" and "ng-user-compute-spot-2022-12-v1-21"
#eksctl create nodegroup --config-file "../eksctl/cluster-config.yaml" --profile $PROFILE  # parrallel updated nodegroups
#sleep 10
#kubectl get nodes
#sleep 10
#eksctl delete nodegroup --config-file "../eksctl/cluster-config.yaml" --only-missing --profile $PROFILE
